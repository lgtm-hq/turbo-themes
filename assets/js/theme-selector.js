var TurboThemeSelector = (function(exports) {
	...
	var tokens = {
		...
		$description: "Turbo Themes - Flat tokens for 26 themes",
		$version: "0.23.0",
		$generated: "ad6d26f17ad23502c62a6d6204348a3045e0737d0a720ee05575a33285b6df90",
		meta: {
			"themeIds": [
				"bulma-dark",
				"bulma-light",
	...
	var ErrorLevel = function(ErrorLevel) {
	...
	async function initTheme(documentObj, windowObj) {
		...
		if (initialTheme && initialTheme === savedTheme) {
			if (getCurrentThemeFromClasses(documentObj.documentElement) === savedTheme) {
				...
				if (!(documentObj.getElementById(themeLinkId) || documentObj.getElementById("turbo-theme-css"))) await applyTheme(documentObj, savedTheme);
				return;
			}
		}
