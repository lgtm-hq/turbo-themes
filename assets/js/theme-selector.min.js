...
})();`}async function ve(e,a,o){Ne(a);const r=a.__INITIAL_THEME__,t=o?.defaultTheme??E,n=oe(a,S(o),t);if(r&&r===n&&ne(e.documentElement)===n){await G(e,n);return}await G(e,n)}async function ke(e,a,o){const r=new AbortController,t=na(e);if(!t)return{cleanup:()=>r.abort()};const{dropdownMenu:n,selectEl:i}=t,c=M(e),d=ce(o),s=S(o),l=o?.defaultTheme??E,h={currentIndex:-1,menuItems:[]},y=oe(a,s,l)||le(e,l),k=Ye(t,h),p={documentObj:e,windowObj:a,baseUrl:c,currentThemeId:y,selectEl:i,menuItems:h.menuItems,closeDropdown:k.closeDropdown,onThemeSelect:async ga=>{await ge(ga,e,a)}};return i&&ta(p,i,d,l),ra(p,n,d,ee),Qe(e,t,h,k,r),k.updateAriaExpanded(!1),t.dropdown.classList.remove("is-active"),{cleanup:()=>r.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await ve(document,window);const{cleanup:e}=await ke(document,window);me(document);const a=o=>{o.persisted||(e(),window.removeEventListener("pagehide",a))};window.addEventListener("pagehide",a)}catch(e){f(g.INIT_FAILED(e))}}),b.PREFETCH_TRIGGER_ATTRIBUTE=V,b.THEME_CHANGE_EVENT=T,b.applyTheme=ge,b.enhanceAccessibility=me,b.generateBlockingScript=la,b.getCurrentTheme=Ke,b.initNavbar=he,b.initTheme=ve,b.isThemeCSSLoaded=R,b.loadThemeCSSOnDemand=ia,b.prefetchThemeCSS=ye,b.shouldLoadThemeCSS=sa,b.subscribeToThemeChanges=We,b.wireFlavorSelector=ke,b.wireHoverPrefetch=ca,b})({});
