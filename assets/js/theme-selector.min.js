...
})();`}async function Z(e,a){le(a);const o=a.__INITIAL_THEME__,t=V(a,R());if(o&&o===t&&j(e.documentElement)===t){await L(e,t);return}await L(e,t)}async function ee(e,a){const o=new AbortController,t=He(e);if(!t)return{cleanup:()=>o.abort()};const{dropdownMenu:s,selectEl:n}=t,r=$(e),i=q(),d={currentIndex:-1,menuItems:[]},c=V(a,R())||Ae(e,w),l=Se(t,d),m={documentObj:e,windowObj:a,baseUrl:r,currentThemeId:c,selectEl:n,menuItems:d.menuItems,closeDropdown:l.closeDropdown,onThemeSelect:async h=>{be(a,h,R()),await L(e,h)}};return n&&_e(m,n,i,w),Fe(m,s,i,P),Te(e,t,d,l,o),l.updateAriaExpanded(!1),t.dropdown.classList.remove("is-active"),{cleanup:()=>o.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await Z(document,window);const{cleanup:e}=await ee(document,window);Q(document);const a=o=>{o.persisted||(e(),window.removeEventListener("pagehide",a))};window.addEventListener("pagehide",a)}catch(e){f(b.INIT_FAILED(e))}}),y.enhanceAccessibility=Q,y.generateBlockingScript=De,y.initNavbar=X,y.initTheme=Z,y.wireFlavorSelector=ee,y})({});
