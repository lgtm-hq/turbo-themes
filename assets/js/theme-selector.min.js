...
})();`}async function ce(e,a){we(a);const o=a.__INITIAL_THEME__,r=K(a,L());if(o&&o===r&&Q(e.documentElement)===r){await N(e,r);return}await N(e,r)}async function de(e,a){const o=new AbortController,r=We(e);if(!r)return{cleanup:()=>o.abort()};const{dropdownMenu:s,selectEl:t}=r,n=X(e),c=ee(),d={currentIndex:-1,menuItems:[]},i=K(a,L())||ae(e,B),l=Oe(r,d),u={documentObj:e,windowObj:a,baseUrl:n,currentThemeId:i,selectEl:t,menuItems:d.menuItems,closeDropdown:l.closeDropdown,onThemeSelect:async y=>{await oe(y,e,a)}};return t&&qe(u,t,c,B),ze(u,s,c,q),Ge(e,r,d,l,o),l.updateAriaExpanded(!1),r.dropdown.classList.remove("is-active"),{cleanup:()=>o.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await ce(document,window);const{cleanup:e}=await de(document,window);ie(document);const a=o=>{o.persisted||(e(),window.removeEventListener("pagehide",a))};window.addEventListener("pagehide",a)}catch(e){b(g.INIT_FAILED(e))}}),p.THEME_CHANGE_EVENT=I,p.applyTheme=oe,p.enhanceAccessibility=ie,p.generateBlockingScript=Ke,p.getCurrentTheme=_e,p.initNavbar=se,p.initTheme=ce,p.subscribeToThemeChanges=Ue,p.wireFlavorSelector=de,p})({});
