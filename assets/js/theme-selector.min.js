...
})();`}async function ye(e,a){Le(a);const o=a.__INITIAL_THEME__,r=oe(a,M());if(o&&o===r&&ne(e.documentElement)===r){await G(e,r);return}await G(e,r)}async function ve(e,a){const o=new AbortController,r=oa(e);if(!r)return{cleanup:()=>o.abort()};const{dropdownMenu:n,selectEl:t}=r,i=x(e),c=ie(),d={currentIndex:-1,menuItems:[]},s=oe(a,M())||de(e,k),l=qe(r,d),u={documentObj:e,windowObj:a,baseUrl:i,currentThemeId:s,selectEl:t,menuItems:d.menuItems,closeDropdown:l.closeDropdown,onThemeSelect:async y=>{await le(y,e,a)}};return t&&aa(u,t,c,k),ea(u,n,c,ee),Ye(e,r,d,l,o),l.updateAriaExpanded(!1),r.dropdown.classList.remove("is-active"),{cleanup:()=>o.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await ye(document,window);const{cleanup:e}=await ve(document,window);he(document);const a=o=>{o.persisted||(e(),window.removeEventListener("pagehide",a))};window.addEventListener("pagehide",a)}catch(e){f(g.INIT_FAILED(e))}}),b.PREFETCH_TRIGGER_ATTRIBUTE=P,b.THEME_CHANGE_EVENT=S,b.applyTheme=le,b.enhanceAccessibility=he,b.generateBlockingScript=sa,b.getCurrentTheme=je,b.initNavbar=pe,b.initTheme=ye,b.isThemeCSSLoaded=T,b.loadThemeCSSOnDemand=ta,b.prefetchThemeCSS=ue,b.shouldLoadThemeCSS=ra,b.subscribeToThemeChanges=ze,b.wireFlavorSelector=ve,b.wireHoverPrefetch=na,b})({});
