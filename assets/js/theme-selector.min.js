...
})();`}async function me(e,a){Te(a);const o=a.__INITIAL_THEME__,r=ee(a,D());if(o&&o===r&&re(e.documentElement)===r){await J(e,r);return}await J(e,r)}async function ue(e,a){const o=new AbortController,r=Qe(e);if(!r)return{cleanup:()=>o.abort()};const{dropdownMenu:t,selectEl:n}=r,s=x(e),c=ne(),d={currentIndex:-1,menuItems:[]},i=ee(a,D())||ie(e,B),l=Ve(r,d),u={documentObj:e,windowObj:a,baseUrl:s,currentThemeId:i,selectEl:n,menuItems:d.menuItems,closeDropdown:l.closeDropdown,onThemeSelect:async y=>{await ce(y,e,a)}};return n&&Ze(u,n,c,B),Xe(u,t,c,Z),qe(e,r,d,l,o),l.updateAriaExpanded(!1),r.dropdown.classList.remove("is-active"),{cleanup:()=>o.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await me(document,window);const{cleanup:e}=await ue(document,window);be(document);const a=o=>{o.persisted||(e(),window.removeEventListener("pagehide",a))};window.addEventListener("pagehide",a)}catch(e){b(f.INIT_FAILED(e))}}),g.PREFETCH_TRIGGER_ATTRIBUTE=O,g.THEME_CHANGE_EVENT=M,g.applyTheme=ce,g.enhanceAccessibility=be,g.generateBlockingScript=ta,g.getCurrentTheme=$e,g.initNavbar=fe,g.initTheme=me,g.isThemeCSSLoaded=w,g.loadThemeCSSOnDemand=oa,g.prefetchThemeCSS=he,g.shouldLoadThemeCSS=aa,g.subscribeToThemeChanges=Pe,g.wireFlavorSelector=ue,g.wireHoverPrefetch=ra,g})({});
