...
})();`}async function Z(e,a){me(a);const o=a.__INITIAL_THEME__,t=V(a,T());if(o&&o===t&&j(e.documentElement)===t){const n=`theme-${t}-css`;e.getElementById(n)||e.getElementById("turbo-theme-css")||await R(e,t);return}await R(e,t)}async function ee(e,a){const o=new AbortController,t=De(e);if(!t)return{cleanup:()=>o.abort()};const{dropdownMenu:n,selectEl:s}=t,r=z(e),i=q(),d={currentIndex:-1,menuItems:[]},c=V(a,T())||Se(e,w),l=Me(t,d),m={documentObj:e,windowObj:a,baseUrl:r,currentThemeId:c,selectEl:s,menuItems:d.menuItems,closeDropdown:l.closeDropdown,onThemeSelect:async h=>{he(a,h,T()),await R(e,h)}};return s&&He(m,s,i,w),_e(m,n,i,$),Te(e,t,d,l,o),l.updateAriaExpanded(!1),t.dropdown.classList.remove("is-active"),{cleanup:()=>o.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await Z(document,window);const{cleanup:e}=await ee(document,window);Q(document);const a=()=>{e(),window.removeEventListener("pagehide",a)};window.addEventListener("pagehide",a)}catch(e){g(b.INIT_FAILED(e))}}),y.enhanceAccessibility=Q,y.generateBlockingScript=Ue,y.initNavbar=X,y.initTheme=Z,y.wireFlavorSelector=ee,y})({});
