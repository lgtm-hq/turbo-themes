...
})();`}async function te(e,a){ke(a);const o=a.__INITIAL_THEME__,r=W(a,T());if(o&&o===r&&X(e.documentElement)===r){await L(e,r);return}await L(e,r)}async function ne(e,a){const o=new AbortController,r=Ge(e);if(!r)return{cleanup:()=>o.abort()};const{dropdownMenu:i,selectEl:t}=r,n=K(e),c=Q(),d={currentIndex:-1,menuItems:[]},s=W(a,T())||Re(e,E),l=Te(r,d),h={documentObj:e,windowObj:a,baseUrl:n,currentThemeId:s,selectEl:t,menuItems:d.menuItems,closeDropdown:l.closeDropdown,onThemeSelect:async u=>{Be(a,u,T()),await L(e,u)}};return t&&je(h,t,c,E),Je(h,i,c,z),He(e,r,d,l,o),l.updateAriaExpanded(!1),r.dropdown.classList.remove("is-active"),{cleanup:()=>o.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await te(document,window);const{cleanup:e}=await ne(document,window);re(document);const a=o=>{o.persisted||(e(),window.removeEventListener("pagehide",a))};window.addEventListener("pagehide",a)}catch(e){b(g.INIT_FAILED(e))}}),y.enhanceAccessibility=re,y.generateBlockingScript=Pe,y.initNavbar=oe,y.initTheme=te,y.wireFlavorSelector=ne,y})({});
