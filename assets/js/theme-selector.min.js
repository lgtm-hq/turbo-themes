...
})();`}async function re(e,a){ke(a);const o=a.__INITIAL_THEME__,t=W(a,N());if(o&&o===t&&X(e.documentElement)===t){await F(e,t);return}await F(e,t)}async function ne(e,a){const o=new AbortController,t=Pe(e);if(!t)return{cleanup:()=>o.abort()};const{dropdownMenu:i,selectEl:r}=t,n=K(e),c=Q(),d={currentIndex:-1,menuItems:[]},s=W(a,N())||Re(e,B),l=Ne(t,d),h={documentObj:e,windowObj:a,baseUrl:n,currentThemeId:s,selectEl:r,menuItems:d.menuItems,closeDropdown:l.closeDropdown,onThemeSelect:async u=>{we(a,u,N()),await F(e,u)}};return r&&Ge(h,r,c,B),Je(h,i,c,z),He(e,t,d,l,o),l.updateAriaExpanded(!1),t.dropdown.classList.remove("is-active"),{cleanup:()=>o.abort()}}return typeof document<"u"&&typeof window<"u"&&document.addEventListener("DOMContentLoaded",async()=>{try{await re(document,window);const{cleanup:e}=await ne(document,window);te(document);const a=o=>{o.persisted||(e(),window.removeEventListener("pagehide",a))};window.addEventListener("pagehide",a)}catch(e){f(b.INIT_FAILED(e))}}),y.enhanceAccessibility=te,y.generateBlockingScript=$e,y.initNavbar=oe,y.initTheme=re,y.wireFlavorSelector=ne,y})({});
