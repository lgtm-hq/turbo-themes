...
/**
 * Auto-generated TypeScript API reference (typedoc-plugin-markdown output).
 * Generated by `bun run docs:api` before each site build.
 * Files are gitignored; do not edit by hand.
 */
