...
- Update dependency style-dictionary to 5.5.3 (patch) (#1015)
...
- Update dependency stylelint to 17.15.0 (minor) (#1000)
...
- Update dependency bun to 1.4.1 (patch) (#996)

## [0.44.1] - 2026-09-07

### 🔧 Changed

- Update renovatebot/github-action action to v46.2.6 (patch) (#994)
...
- Update ghcr.io/lgtm-hq/py-lintro docker tag to 0.147.3 (minor) (#969)
...
- Update dependency postcss to 8.5.26 (patch) (#894)

## [0.41.18] - 2026-08-16

### 🔧 Changed

- Update dependency esbuild to 0.28.2 (patch) (#891)
- Update dependency cssnano to 8.0.5 (patch) (#890)
...
- Route docs commits to the Internal changelog section (#723)
...
- Generate theme metadata maps from tokens (#610)
...
- Inventory shared docs navigation shell (#601)

## [0.30.1] - 2026-07-19

### 🤖 Internal

- Make theme-sync formatting deterministic across CI environments (#652)
...
- Retry transient push rejection for version PRs (#568)
...
- guard process before reading NODE_ENV in catalog dev warning (#625)
...
- enforce drift checks for generated artifacts (#628)
...
- make tokens.json $generated cover $version (#569)

## [0.28.0] - 2026-07-18

### ✨ Added

- add createThemeCatalog API, themeSets, and ThemeId type (#563)
...
- add consistent data-testid attributes to interactive elements (#578)

## [0.25.1] - 2026-07-18

### 🐛 Fixed

- request CODEOWNER review on release version PRs (#577)
...
- update oxfmt to 0.48.0 (minor) (#480)
...
- update astro to 6.2.1 (minor) (#471)

## [0.20.42] - 2026-05-03

### 🐛 Fixed

- update devalue to 5.8.0 (minor) (#469)

## [0.20.41] - 2026-05-03

### 🐛 Fixed

- update style-dictionary to 5.4.0 (minor) (#455)
...
- update oxlint to 1.62.0 (minor) (#453)

## [0.20.38] - 2026-05-01

### 🐛 Fixed

- update oxfmt to 0.47.0 (minor) (#452)
...
- update @axe-core/playwright to 4.11.3 (#446)

## [0.20.33] - 2026-05-01

### 🐛 Fixed

- update lintro to 0.61.1 (minor) (#434)
